/*
 see: 
 https://github.com/longcw/RoIAlign.pytorch/blob/master/README.md
 https://github.com/longcw/RoIAlign.pytorch/blob/master/roi_align/src/crop_and_resize_gpu.cpp
 
 longcw provides a 2D RoIAlign that I have adopted for 3D RoIAlign below
